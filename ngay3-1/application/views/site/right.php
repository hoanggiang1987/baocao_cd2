	     ...
	     <div class="box-right">
			    ...
			    <div class="content-box">
			         ...
			         <div class="support">
                    <strong>Nhóm Báo Cáo </strong>				
	      
	      <p>
	         <img style="margin-bottom:-3px" src="<?php echo public_url()?>/site/images/phone.png"> 0936 829 899	      </p>
	      
		  <p>
			<a rel="nofollow" href="mailto:hoangvantuyencnt@gmail.com">
			    <img style="margin-bottom:-3px" src="<?php echo public_url()?>/site/images/email.png"> Email:sinhvien@gmail.com
		    </a>
		  </p>
		  <p>
			<a rel="nofollow" href="skype:tuyencnt90">
			     <img style="margin-bottom:-3px" src="<?php echo public_url()?>/site/images/skype.png"> Skype: hoang			</a>
		</p>	
		</div>			        </div>
          </div>
       <!-- End Support -->
		 ...
		 <!-- The Fanpage -->
	       <div class="box-right">
			    ...
			    <div class="content-box">
					...
					</script><div id="histats_counter_1552" style="display: block;"><a href="http://www.histats.com/viewstats/?sid=2138481&amp;ccid=401" target="_blank"><canvas id="histats_counter_1552_canvas" width="119" height="81"></canvas></a></div></a>
